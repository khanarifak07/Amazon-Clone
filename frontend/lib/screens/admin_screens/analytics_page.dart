...
class AnaylyticsPage extends StatefulWidget {
  const AnaylyticsPage({super.key});

  @override
  State<AnaylyticsPage> createState() => _AnaylyticsPageState();
}

class _AnaylyticsPageState extends State<AnaylyticsPage> {
